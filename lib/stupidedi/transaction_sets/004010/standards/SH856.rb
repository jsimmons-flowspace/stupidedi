        ...
        SH856 = b.build("SH", "856", "Ship Notice/Manifest",
          ...
          d::TableDef.detail("2 - Detail",
            d::LoopDef.build("HL", d::RepeatCount.bounded(200000),
              ...
              s::LIN.use( 20, r::Optional, d::RepeatCount.bounded(1)),
              s::SN1.use( 30, r::Optional, d::RepeatCount.bounded(1)),
              s::PRF.use( 50, r::Optional,  d::RepeatCount.bounded(1)),
              ...
              s::MAN.use(180, r::Optional,  d::RepeatCount.bounded(1)),
              s::DTM.use(200, r::Optional,  d::RepeatCount.bounded(10))),
